package com.pokemon.api.api.service.impl;

import com.pokemon.api.api.Dto.ReviewDto;
import com.pokemon.api.api.exceptions.PokemonNotFoundException;
import com.pokemon.api.api.exceptions.ReviewNotFoundException;
import com.pokemon.api.api.models.Pokemon;
import com.pokemon.api.api.models.Review;
import com.pokemon.api.api.repository.PokemonRepository;
import com.pokemon.api.api.repository.ReviewRepository;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    public ReviewDto getReviewById(int reviewId, int pokemonId) {
        ...
        Review review = reviewRepository.findById((long) reviewId).orElseThrow(() -> new ReviewNotFoundException("Review with associate pokemon not found"));
