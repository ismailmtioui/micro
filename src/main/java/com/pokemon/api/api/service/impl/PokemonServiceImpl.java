...
public class PokemonServiceImpl implements PokemonService {
   ...
   @Autowired
    ...
    public PokemonDto getPokemonById(int id) {
       Pokemon pokemon = pokemonRepository.findById(id).orElseThrow(()-> new PokemonNotFoundException("pokempon could not be founf"));
    ...
    public void deletePokemon(int id) {
        Pokemon pokemon = pokemonRepository.findById(id).orElseThrow(()-> new PokemonNotFoundException("pokempon could not be deleted"));
